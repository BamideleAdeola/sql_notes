/* WINDOW FUNCTIONS
- Performs calculations on already generated result set (a window)
- To perform aggregate calculations without grouping data
(similar to subqueries in select)
- Examples are running totals, rankings, moving averages, etc

*/

/* Q1: How many goals were scored in each match in 2012/2013
and how did that compared to the average*/
...
-- GENERATE A RANK
/*
A rank simply creates a column numbering dataset from highest to lowest
or vice versa, based on column specified

Q2. What is the rank of matches based on no of goals scored?
*/
...
/*
kEY DIFFERENCES
- Processed after every part of query except the Final ORDER BY
...
/*
Q3. 
Create a data set of ranked matches according to which leagues, 
...
/*
OVER AND PARTITIO BY

Partition by allows one to calculate separate values for different categories
...
-- It uses rows between <start> AND <finish>
...
/*
	Challenge: how badly did Manchester United lose in each match?
